        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section_title text-center">lo mas popular en tienda369</div>
                </div>
            </div>
                ...
                <div class="col">
                    <div class="page_nav">
                        <ul class="d-flex flex-row align-items-start justify-content-center">
                            <li class="active"><a href="category.html">Mujer</a></li>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="product">
                        ...
                        <div class="product_image">
                            <img src="{{ $pro->images->random()->url }}" alt="{{ $pro->nombre}}">
                        </div>
                        ...
                        <div class="product_content">
                            <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                <div>
                                    <div>
                                        <div class="product_name"><a href="">{{ $pro->nombre }}</a></div>
                                        
                                    </div>
                                </div>
                                <div class="ml-auto text-right">
                                    <div class="product_category"><a href="category.html">{{ $pro->category->nombre}}</a></div>
                                </div>
                                
                                
                            </div>

                            <div class="procuct_precio_actual">
                                <h3>Precio Q{{ $pro->precio_actual }}</h3>
                            </div>
            ...
            <div class="row load_more_row">
                <div class="col">
                    <div class="button load_more ml-auto mr-auto"><a href="#">Ver mas</a></div>
                </div>
            </div>
        </div>
    </div>
