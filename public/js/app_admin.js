...
var api_search_autocomplete = new Vue({
  ...
  methods: {
    ...
    */
    select: function select(resultado) {
      var _this2 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this2.palabra_a_buscar = resultado.nombre;
                _context.next = 3;
                return _this2.$nextTick();

              case 3:
                _this2.SubmitForm(); //$nextTick sirve para esperar que luego que se actualice el Dom se ejecute una funcion.                       
...
module.exports = __webpack_require__(/*! C:\laragon\www\tienda369\resources\js\app_admin.js */"./resources/js/app_admin.js");
